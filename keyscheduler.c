...
uint8_t* keyscheduler(uint8_t ikey[16]){
    uint8_t *skey = malloc(176);
    memcpy(skey, ikey, sizeof(uint8_t) * 16);
    ...
    for (int i = 0; i <= 10; i++){
        ...
        for(int i = 0; i < 4; i ++){
            ...
            byterow[boffset] = (nw[i] & 0xff000000) >> 24;
            byterow[boffset + 1] = (nw[i] & 0x00ff0000) >> 16;
            byterow[boffset + 2] = (nw[i] & 0x0000ff00) >> 8;
            byterow[boffset + 3] = nw[i] & 0x000000ff;
        }

        current_offset += 16;
        memcpy(skey + current_offset, byterow, sizeof(byterow));        
    }
